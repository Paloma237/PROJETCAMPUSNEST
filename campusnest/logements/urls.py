...
urlpatterns = [
    ...
    path("chambres/<int:pk>/supprimer/",              views.supprimer_chambre_view,    name="supprimer_chambre"),
    ...
    path("mes-cites/<int:cite_pk>/chambres/<int:chambre_pk>/photos/<int:pk>/supprimer/", views.supprimer_photo_chambre_view, name="logements:supprimer_photo_chambre"),
    path("mes-cites/<int:cite_pk>/photos/<int:pk>/supprimer/", views.supprimer_photo_cite_view, name="supprimer_photo_cite"),
